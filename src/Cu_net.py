...
class Cu_net(nn.Module):
  def __init__(self, input_size=128):
    ...
    conv1 = nn.Conv2d(in_channels=1, out_channels=64, kernel_size=3, stride=2, bias=False)#127
    conv2 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=5, stride=2, bias=False)#62
    conv3 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=2, stride=1, bias=False)
